...
\mathrm{s.t.} & \|\mathbf{y}-\mathbf{D}\mathbf{a}\|_2 \leq \epsilon.
\end{array}
\label{eq-sparse}
\end{equation}
Here $\mathbf{D}=(\mathbf{d}_1,\,\mathbf{d}_2,\cdots ,\,\mathbf{d}_n)$ denotes the dictionary matrix collecting all basis vectors.
...
\begin{equation}
\begin{array}{cl}
\min_{\mathbf{a}} & \|\mathbf{y}-\mathbf{D}\mathbf{a}\|_2^2 \\
...
\begin{equation}
\begin{array}{cl}
\min_{\mathbf{a}} & \|\mathbf{y}-\mathbf{D}\mathbf{a}\|_2^2 + \beta \|\mathbf{a}\|_1
\end{array}
\end{equation}
...
One algorithm called K-SVD uses an iterative procedure by updating the coefficient matrix $\mathbf{A}$ and dictionary $\mathbf{D}$ separately
\begin{equation}
\begin{array}{cl}
\min_{\mathbf{D},\mathbf{A}} & \|\mathbf{Y}-\mathbf{D}\mathbf{A}\| \\
